...
import com.Dropbox.pages.DropboxHomePage;
import com.Dropbox.pages.DropboxLoginPage;
import com.Dropbox.pages.DropboxActivitypage;
...
public class BaseScenarios {
	...
	public DropboxHomePage homepage;
	public DropboxActivitypage activitypage;
	public DropboxLoginPage loginpage;
	...
	public void invokeBrowser() {
		...
		try {
			...
			homepage = new DropboxHomePage(driver);
			activitypage = new DropboxActivitypage(driver);
			loginpage = new DropboxLoginPage(driver);
